@echo off 
title 電子鐘附秒版-高效能極精準款 (炫彩爆炸)
mode con cols=58 lines=7
set m=2
:top
set /a color1=%random%%%15+1
set /a color2=%random%%%15+1
if %color1% == %color2% goto top
if %color1% == 10 set color1=a
if %color2% == 10 set color2=a
if %color1% == 11 set color1=b
if %color2% == 11 set color2=b
if %color1% == 12 set color1=c
if %color2% == 12 set color2=c
if %color1% == 13 set color1=d
if %color2% == 13 set color2=d
if %color1% == 14 set color1=e
if %color2% == 14 set color2=e
if %color1% == 15 set color1=f
if %color2% == 15 set color2=f
COLOR %color1%%color2%
